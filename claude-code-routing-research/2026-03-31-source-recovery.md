...
## 恢复结果
恢复目录：`recovered/claude-code-original/`
...
## 参考
- `recovered/claude-code-original/RECOVERY_NOTES.md`
- `recovered/claude-code-original/MANIFEST.json`
- `recovered/claude-code-original/MANIFEST.files.json`
